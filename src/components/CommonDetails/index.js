          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="mt-10 flex flex-col items-center justify-between space-y-4 botder-t border-b py-4 sm:flex-row sm:space-y-0">
              ...
              <button
                ...
                className="mt-1.5 inline-block bg-black px-5 py-3 text-xs font-medium tracking-wide uppercase text-white rounded-lg"
              >
            ...
            <ul className="mt-8 space-y-2">
              ...
              <li className="flex items-center text-left text-sm font-medium text-green-600">
                {"Cancel anytime"}
              </li>
            </ul>
